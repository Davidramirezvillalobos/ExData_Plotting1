...
with(data1, plot(full_date, Sub_metering_1, type = "l", ylim = range(c(Sub_metering_1, Sub_metering_2)), ylab = "Energy sub metering", xlab = " "))
par(new = TRUE)
with(data1, plot(full_date, Sub_metering_2, type = "l", ylim = range(c(Sub_metering_1, Sub_metering_2)),axes = FALSE, xlab = " ", ylab = " ", col = "red"))
par(new = TRUE)
with(data1, plot(full_date, Sub_metering_3, type = "l", ylim = range(c(Sub_metering_1, Sub_metering_2)),axes = FALSE, xlab = " ", ylab = " ", col = "blue"))
